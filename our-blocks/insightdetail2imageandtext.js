...
registerBlockType("ourblocktheme/insightdetail2imageandtext", {
  ...
  attributes: {
    ...
    text: { type: "string" },
    imgID: { type: "number" },
    imgURL: { type: "string", default: insightdetail2imageandtext.fallbackimage },
    imgID2: { type: "number" },
    imgURL2: { type: "string", default: insightdetail2imageandtext.fallbackimage }
  },
  edit: EditComponent,
  save: SaveComponent
})
